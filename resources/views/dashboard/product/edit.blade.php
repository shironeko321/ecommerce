                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body pb-2">
                                                <div class="d-flex justify-content-center pt-2 gap-2">
                                                    <input type="button" value="Hapus" class="btn btn-danger btn-sm delete-image" id="{{ $item->id }}">
                                                    <input type="button" value="Detail" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detail-image-{{ $item->id }}">
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if(e.target.id && hapus === "Hapus") {
                            ...
                            $('form').append('<input type="hidden" name="delete[]" value="' + res.file_name + '">')
                        } else {
                            ...
                            $('form').find('input[name="delete[]"][value="' + res.file_name + '"]').remove()
                        }
                    }
                })
            })
